...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Select(e => new { e.Sal, e.DeptNo }).Where(e => e.DeptNo == 30).Min(e => e.Sal);
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps.Join(depts, e => e.DeptNo, d => d.DeptNo, (e, d) => new { e.EName, e.Sal, d.DName }).SelectMany(ed => grades
            .Where(g => ed.Sal >= g.Losal && ed.Sal <= g.Hisal).Select(g => new { ed.EName, ed.DName, g.Grade })).ToList();
